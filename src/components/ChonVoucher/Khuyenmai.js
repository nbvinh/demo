...
const Khuyenmai = (props) => {
    ...
    const styleisChoose = isChoose ? [AppStyle.StyleVoucherCGV.address, { marginTop: 20, marginLeft: 10,borderWidth:1,borderColor: 'red' }] : [AppStyle.StyleVoucherCGV.address, { marginTop: 20, marginLeft: 10 }] 
    ...
    return (
        ...
        //         />
        //         <View style={AppStyle.StyleChonVoucher.content1}>
        //             <Text style={AppStyle.StyleChonVoucher.text1}>Giảm 10k cho hóa đơn tối thiểu 300k</Text>
        ...
        //             />
        //             <View style={AppStyle.StyleChonVoucher.content1}>
        //                 <Text style={AppStyle.StyleChonVoucher.text1}>Giảm 20k cho hóa đơn tối thiểu 500k </Text>
        //                 <Text style={AppStyle.StyleChonVoucher.text3}>HSD:30/12/2020</Text>
        //             </View>
        //             <View style={AppStyle.StyleChonVoucher.content2}>
