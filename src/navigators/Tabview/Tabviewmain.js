...
const TabViewMain = () =>{
    return(
        <Tab.Navigator tabBarOptions={{style:{backgroundColor:'black', borderTopColor:'black', borderWidth: 1, paddingTop: 20,}}}>
            <Tab.Screen name="Home" component={Main} options={{tabBarLabel : '',tabBarIcon: () =>   <Image width={20} height={18}source={require('../../img/img_icon_24px/home_24px.png')}/>}}/>
